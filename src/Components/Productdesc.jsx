      ...
      <div className="w-full flex flex-col md:flex-row p-4 gap-4">
        ...
        <div className="w-full md:w-1/2 relative h-[90vh]">
          <div
            style={{
              backgroundImage:
                fullProduct.image.length == 0
                  ? `red`
                  : `url(${fullProduct.image[0].secure_url})`,
            }}
          ...
          >
            {fullProduct.image.map((miniImage, index) => (
              <div
                ...
                className="w-1/3 h-48 rounded-[12px] bg-cover bg-center"
              ></div>
            ))}
          </div>
        </div>
        ...
        {/* description */}
        <div className="w-full md:w-1/2 space-y-3 flex flex-col justify-evenly">
          <div>
